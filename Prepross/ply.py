...
def write_points_dddx2(points, path):
    fields = ["x", "y", "z", "scalar_head_x", "scalar_head_y", "scalar_head_z"]
    dtypes = ['double', 'double', 'double', 'double', 'double', 'double']
    write_points_bin(points, path, fields, dtypes)
